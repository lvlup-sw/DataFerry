...
/// <summary>
/// Example concrete LRU cache implementation using Redis as backing store via IRedisClient.
/// Manages LRU metadata in memory, stores values (as bytes) in Redis.
/// </summary>
public class DistributedLruCache<TKey, TValue> : DistributedReplacementPolicyCache<TKey, TValue>
    where TKey : notnull
{
