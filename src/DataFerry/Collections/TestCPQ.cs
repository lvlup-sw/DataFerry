...
namespace lvlup.DataFerry.Collections
{
    ...
    public class TestCPQ<TKey, TValue> : IProducerConsumerCollection<KeyValuePair<TKey, TValue>> where TKey : IComparable<TKey> where TValue : IEquatable<TValue>
    {
        ...
        public TestCPQ(IEnumerable<KeyValuePair<TKey, TValue>> collection)
        {
