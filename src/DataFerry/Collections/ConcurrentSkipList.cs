...
namespace lvlup.DataFerry.Collections
{
    ...
    /// </devnote>
    public class ConcurrentSkipList<TElement, TPriority> : IProducerConsumerCollection<KeyValuePair<TElement, TPriority>>
    {
        /// <summary>
        /// Invalid level.
        /// </summary>
        ...
        public ConcurrentSkipList(IComparer<TPriority> keyComparer) : this(keyComparer, DefaultNumberOfLevels, DefaultPromotionProbability)
        {
        }
        ...
        public ConcurrentSkipList(IComparer<TPriority> keyComparer, int numberOfLevels, double promotionProbability)
        {
